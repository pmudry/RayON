...
class SDFShape : public Hittable
{
 public:
                                            ...
                                            const Vec3 &rotation = Vec3(0, 0, 0))
   {
      ...
      shape->distance_func = [center, radius](const Vec3 &p) { return SDF::sdSphere(p, center, radius); };
    ...
    */
   static shared_ptr<SDFShape> createTorus(const Vec3 &center, double major_radius, double minor_radius,
                                           shared_ptr<Material> mat, const Vec3 &rotation = Vec3(0, 0, 0))
   {
      auto shape = make_shared<SDFShape>(mat);
    ...
    */
   static shared_ptr<SDFShape> createCylinder(const Vec3 &center, double height, double radius,
                                              shared_ptr<Material> mat, const Vec3 &rotation = Vec3(0, 0, 0))
   {
      auto shape = make_shared<SDFShape>(mat);
    ...
    */
   static shared_ptr<SDFShape> createMandelbulb(const Vec3 &center, double power, int iterations,
                                                shared_ptr<Material> mat, const Vec3 &rotation = Vec3(0, 0, 0))
   {
      auto shape = make_shared<SDFShape>(mat);
    ...
    */
   static shared_ptr<SDFShape> createDeathStar(const Vec3 &center, double main_radius, double cutout_radius,
                                               double cutout_distance, shared_ptr<Material> mat,
                                               const Vec3 &rotation = Vec3(0, 0, 0))
   {
      auto shape = make_shared<SDFShape>(mat);
    ...
    */
   static shared_ptr<SDFShape> createCutHollowSphere(const Vec3 &center, double radius, double cut_height,
                                                     double thickness, shared_ptr<Material> mat,
                                                     const Vec3 &rotation = Vec3(0, 0, 0))
   {
      auto shape = make_shared<SDFShape>(mat);
    ...
    */
   static shared_ptr<SDFShape> createOctahedron(const Vec3 &center, double size, shared_ptr<Material> mat,
                                                const Vec3 &rotation = Vec3(0, 0, 0))
   {
      auto shape = make_shared<SDFShape>(mat);
    ...
    */
   static shared_ptr<SDFShape> createPyramid(const Vec3 &center, double height, shared_ptr<Material> mat,
                                             const Vec3 &rotation = Vec3(0, 0, 0))
   {
      auto shape = make_shared<SDFShape>(mat);
    ...
    */
   void setRayMarchConfig(const SDF::RayMarchConfig &cfg) { config = cfg; }
...
class SDFCompound : public Hittable
{
 public:
   ...
   SDFCompound(shared_ptr<SDFShape> shape1, shared_ptr<SDFShape> shape2, Operation op, shared_ptr<Material> mat,
               double blend = 0.5)
