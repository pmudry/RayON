...
(function () {
   ...
   const PRESETS = {
      subtle:   { count: 30, masterOpacity: 0.3,  speedMin: 0.8,  speedMax: 1.5,  opacityMin: 0.2, opacityMax: 0.8, glow: 0.5, dotBrightness: 1.8, rayLength: 400, fadeZone: 120 },
   ...
   const DOT_SCATTER          = 3;
   const DOT_TRAVEL_SPEED_MIN = 0.0007;
   ...
   const TIP_CIRCLE_RADIUS_MAX   = 5;
   const TIP_CIRCLE_PULSE_SPEED  = 0.045;
   const TIP_CIRCLE_GLOW_SIZE    = 9;
   const TIP_CIRCLE_MIN_OPACITY  = 1.0;
