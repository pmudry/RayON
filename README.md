[![License: GPL v3](https://img.shields.io/badge/License-GPLv3-blue.svg)](https://www.gnu.org/licenses/gpl-3.0) [![GitHub release](https://img.shields.io/github/v/release/pmudry/RayON?include_prereleases)](https://github.com/pmudry/RayON/releases/latest) [![Documentation](https://img.shields.io/badge/docs-online-blue)](https://pmudry.github.io/RayON) [![Deploy Documentation](https://github.com/pmudry/RayON/actions/workflows/deploy-docs.yml/badge.svg)](https://github.com/pmudry/RayON/actions/workflows/deploy-docs.yml) [![Docs Sync Check](https://github.com/pmudry/RayON/actions/workflows/docs-sync-check.yml/badge.svg)](https://github.com/pmudry/RayON/actions/workflows/docs-sync-check.yml) 
...
- Has been tested on DGX Spark and on x86_64 (Ubuntu 24.04). Other platforms are untested yet.other platforms are untested.
